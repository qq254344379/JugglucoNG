...
#ifndef WEAROS
constexpr static std::string_view eslabels[] = {
    "Carbohidra", "Dextro",  "Fast Insuli", "Insu largos",
    "Bicicleta",  "Caminar", "Sangre"};
constexpr static Shortcut_t esshortinit[] = {{"Pan", .48},
                                             {"Currantbun1", .56f},
                                             {"Currantbun2", .595f},
                                             {"Uvas", .165f},
                                             {"FruitYog", .058f},
                                             ...
                                             {"SportPowder", .873f},
                                             {"Mix(Carrot)", .07f},
                                             {"Mix mushro", .07300000f}};
#endif

extern jugglucotext estext;

jugglucotext estext{
    .daylabel = {"Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"},
    .speakdaylabel = {"Domingo", "Lunes", "Martes", "Miércoles", "Jueves",
                      "Viernes", "Sábado"},
    .monthlabel = {"Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago",
                   "Sep", "Oct", "Nov", "Dic"},

    .scanned = "Escaneado",
    .readysecEnable = "Sensor listo en %d minutos. Escanee nuevamente para "
    ...
    .menustr0 = {"Interfaz        ", "Menús", "Reloj", "Sensor", "Ajustes",
#if defined(SIBIONICS)
                 "Foto",
#else
                 "Acerca",
#endif
                 "Cerrar", "Detener alarma"},
    .menustr1 = {"Exportar", "Espejo", estext.newamount, "Lista",
                 "Estadísticas", "Hablar", "Flotante        "},
    .menustr2 = {"Calibrated", "Escaneos", "Flujos", "Historial", "Cantidades",
                 "Comidas", "Modo oscuro         "},

    .menustr3 = {hourminstr, "Buscar", "Fecha", "Día atrás", "Día después",
                 "Semana atrás", "Semana despues"},
#else
    .amount = "Cuantía",
    .menustr0 = {"        Espejo", "Sensor", "Display", "Ajustes",
                 "Detener alarma"},
    .menustr2 = {"Fecha ", hourminstr, "Día atrás               ",
                 estext.amount},
#endif

    .scanerrors = {{"Error de escaneo (%d)", "Intentar de nuevo"},
                   {"Error de instalación", "?"},
                   {"Error de procesamiento de datos", "Intentar de nuevo"},
                   {"Activando sensor", ""},
                   {"El sensor ha finalizado definitivamente", ""},

                   {"Sensor listo en", "%d minutos"},
                   {"Error de sensor (373)", "Intentar de nuevo más tarde"},
                   ...
                   {"Clase Error de inicialización", "Haz algo"},
                   {"El procedimiento tarda demasiado", "Cierro el programa"},
                   {"Reemplazar sensor (365)",
                    "Tu sensor no está funcionando. Por favor, retira tu "
                    "sensor y empieza uno nuevo."},
                   {"Reemplazar sensor (368)",
                    "Tu sensor no está funcionando. Retire su sensor y "
                    "comience uno nuevo."},
                   {"", ""},
                   {"Error de escaneo", "Inténtelo de nuevo"}},

    .libre3scanerror = {"FreeStyle Libre 3, error de escaneo",
                        "Inténtelo de nuevo"},
    .libre3wrongID =
        {"Error, ¿ID de cuenta incorrecta?",
    ...
    .unknownNFC = {"Error de escaneo NFC no reconocido", "Inténtelo de nuevo"},
    .nolibre3 =
        {"Sensor FreeStyle Libre 3",
         ...
         "Descargue la versión correcta de "
         "https://www.juggluco.nl/download.html"},
#ifndef WEAROS
