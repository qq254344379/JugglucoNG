...
constexpr static std::string_view rulabels[] = {
    "Yглeвoд", "Сахар", "Kopoтkuй", "Дoлгuй", "Велик", "Хoдьбa", "Кровь"};

constexpr static Shortcut_t rushortinit[] = {
    {"Хлеб", .48},      {"Яблoкo", .165f},    {"Фрукт", .058f}, {"Рис", .75f},
    {"Makaрoны", .65f}, {"Томат", .03f},      {"Суп", .078f},   {"Сок", .109f},
    {"Спорт", .873f},   {"Грибы", .07300000f}};
#endif
...
jugglucotext rutext{
...
#ifdef INJUGGLUCO
    .speakdaylabel = {"Воскресенье", "Понедельник", "Вторник", "Среда",
                      "Четверг", "Пятница", "Суббота"},
    .monthlabel = {"Янв", "Фев", "Мар", "Апр", "Май", "Июн", "Июл", "Авг",
                   "Сен", "Окт", "Ноя", "Дек"},

    .scanned = "Сканирование",
    .readysecEnable = "Датчик будет готов через %d минут. Повторите "
                      "сканирование, чтобы включить потоковую передачу.",
    ...
    .menustr0 = {"System UI        ", "Меню", "Часы", "Датчик", "Настройки",
#if defined(SIBIONICS)
                 "Photo",
#else
                 "About",
#endif
                 "Закрыть", "Стоп тревога"},
    .menustr1 = {"Экспорт", "Зеркало", rutext.newamount, "Все записи",
#else
    .statistics =
#endif // INJUGGLUCO
                 "Статистика",
#ifdef INJUGGLUCO
                 "Озвучка", "Плав. глюк.        "},
    .menustr2 = {"Calibrated", "Сканирование        ", "Поток", "История",
                 "Записи", "Еда", "Темная тема"},
    .menustr3 = {hourminstr, "Поиск", "К дате", "День назад", "День вперед",
                 "Неделя назад", "Неделя вперед"},
#endif // INJUGGLUCO
#else
    .amount = "Значение",
    .menustr0 = {"            Зеркало", "Датчик", "Дисплей", "Настройки",
                 "Стоп тревога"},
    .menustr2 = {"К дате  ", hourminstr, "День назад                ",
                 rutext.amount},
#endif
    ...
    .scanerrors =
        {{"Ошибка скана (%d)", "Попробуйте еще"},
         ...
         {"Заменить датчик (365)", "Ваш датчик не работает. Пожалуйста, "
                                   "снимите ваш датчик и установите новый."},
         {"Заменить датчик (368)", "Ваш датчик не работает. Пожалуйста, "
                                   "снимите ваш датчик и установите новый."},
         {"", ""},
    ...
    .libre3wrongID = {"Ошибка, неверный ID аккаунта?",
                      "Укажите в настройках -> Libreview ту же учетную запись, "
                      "что использовалась для активации датчика"},
    .libre3scansuccess =
        {"FreeStyle Libre 3 датчик",
    ...
    .nolibre3 = {"FreeStyle Libre 3 датчик",
                 "Загрузите правильную версию с сайта "
...
#endif
    .receivingpastvalues = "Загрузка истории",
