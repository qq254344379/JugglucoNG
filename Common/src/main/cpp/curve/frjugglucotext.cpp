...
constexpr static std::string_view labels[] = {
    "Glucides", "Dextro", "Ins. rapide", "Ins. basale",
    "Vélo",     "Marche", "Sang"};
constexpr static Shortcut_t shortinit[] = {
    {"Pain blanc", .48},     {"Pain gris", .56f},  {"Pâtes", .595f},
    {"Raisins", .165f},      {"Yaourt", .058f},    {"Riz", .75f},
    {"Macaroni", .65f},      {"Tomates", .03f},    {"Mix Mexica", .078f},
    {"Jus oranges", .109f},  {"Mix sport", .873f}, {"Mix carotte", .07f},
    {"Aquarius", .07300000f}};
#endif
#endif // INJUGGLUCO
...
jugglucotext frtext{
...
#ifdef INJUGGLUCO
    .speakdaylabel = {"Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi",
                      "Vendredi", "Samedi"},
    .monthlabel = {"Jan", "Fev", "Mar", "Avr", "Mai", "Jun", "Jui", "Aou",
                   "Sep", "Oct", "Nov", "Déc"},

    .scanned = "Scanné",
    .readysecEnable = "Capteur prêt dans %d minutes. Scannez à nouveau pour "
    ...
    .menustr0 = {"Intf. système        ", "Menus", "Montre", "Capteur",
                 "Paramètres",
...
#endif
                 "Fermer", "Arrêt alarme"},
    .menustr1 = {"Exporter", "Miroir", frtext.newamount, "Liste",
#else
    .statistics =
#endif // INJUGGLUCO
                 "Statistiques",
#ifdef INJUGGLUCO
                 "Parler", "Flotter        "},
    .menustr2 = {"Calibrated", "Scans", "Flux", "Historique", "Quantités",
                 "Repas", "Mode sombre        "},
    .menustr3 = {hourminstr, "Rechercher", "Date", "Jour avant", "Jour après",
                 "Semaine avant", "Semaine après"},
#endif // INJUGGLUCO
#else
    .amount = "Quantité",
    .menustr0 = {"        Miroir", "Capteur", "Affichage", "    Paramètres",
                 "Arrêt alarme"},
    .menustr2 = {"Date", hourminstr, "Jour avant                    ",
                 frtext.amount},
#endif
    ...
    .scanerrors =
        {{"Erreur de scan (%d)", "Réessayez"},
         ...
         {"Erreur capteur (373)",
          "Ne contactez pas le service clients d'Abott immédiatement; il est "
          "probable que les données seron disponibles dans 10 minutes."},
         ...
         {"Erreur d'initialisation de la librairie",
          "Manque-t-il des librairies partagées?"},
         {"Erreur d'initialisation de classe", "Faites quelque chose..."},
         {"Processus trop long", "Je ferme le programme"},
         {"Remplacez le capteur (365)",
          "Votre capteur ne fonctionne pas. Vous devez le remplacer et "
          "démarrer un nouveau."},
         {"Remplacez le capteur (368)",
          "Votre capteur ne fonctionne pas. Vous devez le remplacer et "
          "démarrer un nouveau."},
         {"", ""},
