...
#ifdef INJUGGLUCO
#ifndef WEAROS
constexpr static std::string_view nllabels[] = {
    "Koolhydraat", "Dextro",   "Insuli snel", "Insuli lang",
    "Fietsen",     "Wandelen", "Bloed"};
constexpr static Shortcut_t nlshortinit[] = {
    {"Meer. Brood", .42f},  {"Krentbrood1", .56f}, {"Krentbrood2", .595f},
    {"Druiven", .165f},     {"Frucht yog", .058f}, {"Rijst", .75f},
    {"Macaroni", .65f},     {"Tomaat", .03f},      {"Mexican mix", .078f},
    {"Sinappelsap", .109f}, {"SportPowder", .873f}};
#endif
#endif
static jugglucotext nltext{
    .daylabel = {"zo", "ma", "di", "wo", "do", "vr", "za"},
#ifdef INJUGGLUCO
    .speakdaylabel = {"Zondag", "Maandag", "Dinsdag", "Woensdag", "Donderdag",
                      "Vrijdag", "Zaterdag"},
    .monthlabel = {"jan", "feb", "mrt", "apr", "mei", "jun", "jul", "aug",
                   "sep", "okt", "nov", "dec"},

    .scanned = "gescanned",
    .readysecEnable = "Sensor is gereed in %d minuten. Scan nog een keer om "
                      "Streaming aan te zetten.",
    ...
    .historyinfo = "Een keer in 15 minuten, onthouden gedurende 8 uur.\nDoor "
                   "scanning naar Juggluco gezonden.\nSensor: ",
    .history3info = "Een keer in 5 minute.\nVia Bluetooth naar Juggluco "
                    "gezonden.\nSensor: ",
    ...
    .menustr0 = {"System UI        ", "Menus", "Horloges", "Sensor",
                 "Instellingen",
...
#endif
                 "Sluiten", "Stop Alarm"},
    .menustr1 = {"Export", "Kloon", nltext.newamount, "Lijst",
#else
    .statistics =
#endif // INJUGGLUCO
                 "Statistiek",
#ifdef INJUGGLUCO
                 "Praat", "Zweef        "},
    .menustr2 = {"Gekalibreerd", "Scans", "Stream", "History",
                 "Hoeveelheden        ", "Maaltijden", "Dark mode"},
    .menustr3 = {hourminstr, "Zoeken", "Datum", "Dag terug", "Dag later",
                 "Week terug", "Week later"},
#endif
#else
    .amount = "Hoeveelheid",
    .menustr0 = {"       Kloon", "Sensor", "Toon", "   Instellingen",
                 "Stop Alarm"},
    .menustr2 = {"Datum", hourminstr, "Dag terug                    ",
                 nltext.amount},
#endif
#ifdef INJUGGLUCO
    ...
    .scanerrors =
        {{"Scanfout (%d)", "Probeer het opnieuw"},
         ...
         {"Vervang sensor (365)", "Uw sensor werkt niet. Verwijder uw sensor "
                                  "en start een nieuwe sensor."},
         {"Vervang sensor (368)", "Uw sensor werkt niet. Verwijder uw sensor "
                                  "en start een nieuwe sensor."},
         {"", ""},
    ...
    .libre3scansuccess = {"FreeStyle Libre 3-sensor",
                          "Glucosewaarden worden nu ontvangen door Juggluco"},
    .unknownNFC = {"Onbekende NFC-scanfout", "Probeer het opnieuw"},
    .nolibre3 =
        {"FreeStyle Libre 3-sensor",
         "Download de juiste versie van https://www.juggluco.nl/download.html"},
    .libre3zeroID =
        {"Fout, nul account-ID?",
